...
$sql = "select * from tb_locaisDeProva where id = :idLocaisDeProva";

$stm = $pdo->prepare($sql);

$stm->execute([':idLocaisDeProva' => $id]);

$locaisDeProva = $stm->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="card" style="width: 50%;">
                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Título" name="titulo" value="<?php echo $objetivo['titulo']; ?>" aria-label="Título"
                                    aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                        style="height: 100px" name="conteudo" value="<?php echo $objetivo['conteudo']; ?>"></textarea>
                                    <label for="floatingTextarea2"><?php echo $objetivo['conteudo']; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
