...
$sql = "select * from tb_avisos where id = :idAvisos";

$stm = $pdo->prepare($sql);

$stm->execute([':idAvisos' => $id]);

$aviso = $stm->fetch(PDO::FETCH_ASSOC);
            ...
            <center>
                <form action="./atualizar.php" method="post">
                    <div class="card" style="width: 50%;">
                        <div class="card-body">
                            <p class="card-text">Editando Aviso <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Título" name="titulo" value="<?php echo $aviso['titulo']; ?>" aria-label="Título"
                                    aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                        style="height: 100px" name="conteudo" value="<?php echo $aviso['conteudo']; ?>"><?php echo $aviso['conteudo']; ?></textarea>
